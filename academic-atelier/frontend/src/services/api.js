...
// Use the local proxy instead of direct backend URL to avoid CORS issues
const API_BASE_URL = import.meta.env.VITE_API_URL || '/api';

// Python AI API with real Groq integration
...
// AI API client for Python backend
...
// Add JWT token to requests (for Java backend)
...
// Chatbot API now uses Python backend with real Groq AI
export const chatbotAPI = {
  sendMessage: (studentId, message, sessionId) =>
    aiClient.post('/chat', { message, session_id: sessionId, context: `Student ID: ${studentId}` }),
