  ...
  return (
    <div className="fade-in">
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1.4fr 1fr', gap: 20 }}>
        ...
        <div style={{ background: '#fff', borderRadius: 16, padding: 28, boxShadow: '0 1px 3px rgba(0,0,0,0.06)', border: '1px solid #f1f5f9' }}>
          <h3 style={{ margin: '0 0 24px', fontSize: 16, fontWeight: 700, color: '#0f172a' }}>Recent Notifications</h3>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            {notifications.slice(0, 4).map((notif) => (
              ...
              >
                ...
                <div style={{ flex: 1 }}>
                  <p style={{ margin: '0 0 2px', fontSize: 13, fontWeight: notif.read ? 500 : 600, color: notif.read ? '#94a3b8' : '#334155' }}>
                    {notif.title}
                  </p>
                  <span style={{ fontSize: 11, color: '#94a3b8' }}>{notif.time}</span>
                  <p style={{ margin: '4px 0 0', fontSize: 12, color: '#64748b' }}>{notif.description}</p>
                </div>
                {!notif.read && <div style={{ width: 8, height: 8, borderRadius: '50%', background: '#6366f1', marginTop: 4, flexShrink: 0 }} />}
              </div>
            ))}
          </div>
          <Link to="/profile" style={{
            display: 'block', marginTop: 16, fontSize: 13, color: '#6366f1', 
